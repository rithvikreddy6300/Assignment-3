...
\begin{lstlisting}
https://github.com/rithvikreddy6300/Assignment-3/tree/main/code
\end{lstlisting}
%
...
Let $X= \{ (x,y) : 0\leq x \leq 99 ,0\leq y \leq 99 \}$ be a set of random variables. Let $N=2^x5^y$ , then  $\forall (x,y) \in X$, N is a divisor of $10^{99}$.
...
Let $Y=\{(x,y) : (x,y)\in X , x \geq 96,y\geq 96\}$ Let $n= 2^x5^y$ then $\forall (x,y) \in  Y $, n is a divisor of $10^{99}$ and multiple of $10^{96}$
